...
function App():React.JSX.Element{
  ...
  const[rainProbabilition,setRainProbabilition] = useState<string>("30");
  ...
  <View style={[styles.container, night==false?styles.containerBgDay :styles.containerBgNight]}>
    ...
    <View style={styles.detailsContainer}>
      ...
      <Image source={require('./src/assents/images/icon3.png')} style={styles.weatherIcon}/>
    </View>
    <View>
      <Text style={styles.weatherCondition}>{condition}</Text>
      <Text style={styles.text}>Sensação Térmica: {feelsLike}°C</Text>
      <Text style={styles.text}>Probilidade de chuva:{rainProbabilition}%</Text>
      <Text style={styles.text}>Umidade: {humidity}%</Text>
    </View>
    <Image source={require('./src/assents/images/cidade.png')} style={styles.bottomImage}/>  
    </View>
);
}
